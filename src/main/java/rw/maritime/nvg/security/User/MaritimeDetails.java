...
@AllArgsConstructor
@NoArgsConstructor
public class MaritimeDetails implements UserDetails {
    ...
    /**
     * Builds MaritimeDetails from the given User model.
     *
     * @param user the user entity from which to build MaritimeDetails
     * @return MaritimeDetails instance
     */
    public static MaritimeDetails buildUserDetails(User user) {
        // Removed roles mapping logic; simply return the essential user details
        return new MaritimeDetails(
                user.getId(),
                user.getEmail(),
                user.getPassword(),
