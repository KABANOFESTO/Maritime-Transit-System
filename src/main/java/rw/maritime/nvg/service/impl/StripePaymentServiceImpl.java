...
//     private final CargoPaymentRepository cargoPaymentRepository;
...
//                                   CargoPaymentRepository cargoPaymentRepository) {
//         this.ticketRepository = ticketRepository;
//         this.cargoRepository = cargoRepository;
//         this.userRepository = userRepository;
//         this.paymentRepository = paymentRepository;
//         this.ticketPaymentRepository = ticketPaymentRepository;
//         this.cargoPaymentRepository = cargoPaymentRepository;
//     }
...
//                     payment.getTicketPayments().stream()
//                             .map(tp -> tp.getTicket().getId())
//                             .collect(Collectors.toList()),
//                     payment.getCargoPayments().stream()
...
//         if (ticketIds == null || ticketIds.isEmpty()) return 0.0;
        
//         // Assuming ticket price is stored in Schedule or needs to be calculated
//         return ticketRepository.findAllById(ticketIds).stream()
//                 .mapToDouble(ticket -> ticket.getSchedule().getPrice()) // Adjust based on your pricing logic
//                 .sum();
//     }

//     private double calculateCargoAmount(List<Long> cargoIds) {
//         if (cargoIds == null || cargoIds.isEmpty()) return 0.0;
